...
import org.apache.spark.ml.feature.{MinMaxScaler, Normalizer, StandardScaler, StringIndexer}
...
/**
  ...
  */
object SpendingPowerIndexLocal {
  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setMaster("local[2]").setAppName("SpendingPowerIndex")
